...
exports.getRecommendation = exports.listAvailableAlgorithms = exports.AlgorithmType = void 0;
const transform_error_1 = require("@wix/sdk-runtime/transform-error");
const rename_all_nested_keys_1 = require("@wix/sdk-runtime/rename-all-nested-keys");
const ambassadorWixEcomRecommendationsV1Recommendation = __importStar(require("./ecom-recommendations-v1-recommendation-recommendations.http.js"));
var AlgorithmType;
...
async function listAvailableAlgorithms() {
    ...
    const reqOpts = ambassadorWixEcomRecommendationsV1Recommendation.listAvailableAlgorithms(payload);
...
exports.listAvailableAlgorithms = listAvailableAlgorithms;
/**
...
async function getRecommendation(algorithms, options) {
    ...
    const reqOpts = ambassadorWixEcomRecommendationsV1Recommendation.getRecommendation(payload);
    sideEffects?.onSiteCall?.();
    try {
        const result = await httpClient.request(reqOpts);
        sideEffects?.onSuccess?.(result);
...
//# sourceMappingURL=ecom-recommendations-v1-recommendation-recommendations.universal.js.map