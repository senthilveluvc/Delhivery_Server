...
import { Algorithm, GetRecommendationOptions, GetRecommendationResponse, GetRecommendationResponseNonNullableFields, ListAvailableAlgorithmsResponse, ListAvailableAlgorithmsResponseNonNullableFields } from './ecom-recommendations-v1-recommendation-recommendations.universal.js';
export declare const __metadata: {
    PACKAGE_NAME: string;
};
export declare function listAvailableAlgorithms(httpClient: HttpClient): ListAvailableAlgorithmsSignature;
...
export declare function getRecommendation(httpClient: HttpClient): GetRecommendationSignature;
...
export { Algorithm, AlgorithmConfig, AlgorithmInfo, AlgorithmType, CatalogReference, GetRecommendationOptions, GetRecommendationRequest, GetRecommendationResponse, GetRecommendationResponseNonNullableFields, ItemAppIdNotSupportedByProvider, ListAvailableAlgorithmsRequest, ListAvailableAlgorithmsResponse, ListAvailableAlgorithmsResponseNonNullableFields, Recommendation, RecommendationAlgorithmNotSupported, } from './ecom-recommendations-v1-recommendation-recommendations.universal.js';
