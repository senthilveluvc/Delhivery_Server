 ...
 */
export function createCheckoutTemplate(payload) {
...
export function getCheckoutTemplate(payload) {
 ...
 */
export function updateCheckoutTemplate(payload) {
 ...
 */
export function deleteCheckoutTemplate(payload) {
 ...
 */
export function queryCheckoutTemplates(payload) {
 ...
 */
export function createCheckoutFromTemplate(payload) {
 ...
 */
export function createAndRedirectToCheckout(payload) {
