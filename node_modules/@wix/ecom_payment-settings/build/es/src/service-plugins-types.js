...
/** JurisdictionType represents the type of the jurisdiction in which this tax detail applies (e.g. Country,State,County,City,Special). */
export var V1JurisdictionType;
(function (V1JurisdictionType) {
    V1JurisdictionType["UNDEFINED"] = "UNDEFINED";
    V1JurisdictionType["COUNTRY"] = "COUNTRY";
    V1JurisdictionType["STATE"] = "STATE";
    V1JurisdictionType["COUNTY"] = "COUNTY";
    V1JurisdictionType["CITY"] = "CITY";
    V1JurisdictionType["SPECIAL"] = "SPECIAL";
})(V1JurisdictionType || (V1JurisdictionType = {}));
...
export var V1PaymentOption;
(function (V1PaymentOption) {
    V1PaymentOption["UNKNOWN_PAYMENT_OPTION"] = "UNKNOWN_PAYMENT_OPTION";
    V1PaymentOption["MANUAL"] = "MANUAL";
})(V1PaymentOption || (V1PaymentOption = {}));
