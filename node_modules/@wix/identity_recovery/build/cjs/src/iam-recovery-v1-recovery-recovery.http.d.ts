 ...
 */
export declare function sendRecoveryEmail(payload: object): RequestOptionsFactory<any>;
/**
 * Sends an activation email with an activation token
 * making the transition from initial contact to a site member
 */
export declare function sendActivationEmail(payload: object): RequestOptionsFactory<any>;
export declare function recover(payload: object): RequestOptionsFactory<any>;
