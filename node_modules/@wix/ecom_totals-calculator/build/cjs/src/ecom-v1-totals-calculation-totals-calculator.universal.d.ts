 ...
 */
export declare function calculateTotals(options?: CalculateTotalsOptions): Promise<CalculateTotalsResponse & CalculateTotalsResponseNonNullableFields>;
export interface CalculateTotalsOptions extends CalculateTotalsRequestCouponOneOf, CalculateTotalsRequestGiftCardOneOf {
    /**
     * Calculation ID. An identifier of the entity that you are calculating totals for, for example, cart ID or checkout ID.
     * This value will be used in order to optimise calculations by caching.
     * If not passed, calculation might be slower in some cases.
