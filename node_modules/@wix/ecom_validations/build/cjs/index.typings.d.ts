import { GetValidationViolationsResponse } from './src/service-plugins-types.js';
import { GetValidationViolationsEnvelope } from './src/interfaces-ecommerce-v1-validations-provider.public.js';
export * from './src/service-plugins-types';
export { GetValidationViolationsEnvelope };
/**
 ...
 */
export declare function getValidationViolations(payload: GetValidationViolationsEnvelope): GetValidationViolationsResponse | Promise<GetValidationViolationsResponse>;
