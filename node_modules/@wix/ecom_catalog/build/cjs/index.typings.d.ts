import { GetCatalogItemsResponse } from './src/service-plugins-types.js';
import { GetCatalogItemsEnvelope } from './src/interfaces-ecommerce-v1-catalog-provider.public.js';
export * from './src/service-plugins-types';
export { GetCatalogItemsEnvelope };
/**
 ...
 */
export declare function getCatalogItems(payload: GetCatalogItemsEnvelope): GetCatalogItemsResponse | Promise<GetCatalogItemsResponse>;
