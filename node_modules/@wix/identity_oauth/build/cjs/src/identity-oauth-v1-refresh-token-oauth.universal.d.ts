...
export interface TokenInfoResponseNonNullableFields {
    active: boolean;
    subjectType: SubjectType;
    subjectId: string;
    clientId: string;
 ...
 */
export declare function tokenInfo(options?: TokenInfoOptions): Promise<TokenInfoResponse & TokenInfoResponseNonNullableFields>;
