...
export interface GetCurrentCartResponseNonNullableFields {
 ...
 */
export declare function getCurrentCart(): Promise<Cart & CartNonNullableFields>;
/**
 ...
 */
export declare function updateCurrentCart(options?: UpdateCurrentCartOptions): Promise<Cart & CartNonNullableFields>;
export interface UpdateCurrentCartOptions {
    /** Cart info. */
    cartInfo?: Cart;
    /** The code of an existing coupon to apply to the cart. For more information, see the [Coupons API](https://www.wix.com/velo/reference/wix-marketing-backend/coupons). */
    couponCode?: string | null;
 ...
 */
export declare function addToCurrentCart(options?: AddToCurrentCartOptions): Promise<AddToCartResponse & AddToCartResponseNonNullableFields>;
export interface AddToCurrentCartOptions {
    /** Catalog line items. */
    lineItems?: LineItem[];
    /**
     * Custom line items. Custom line items don't trigger the Catalog service plugin.
 ...
 */
export declare function removeLineItemsFromCurrentCart(lineItemIds: string[]): Promise<RemoveLineItemsResponse & RemoveLineItemsResponseNonNullableFields>;
/**
 ...
 */
export declare function createCheckoutFromCurrentCart(options?: CreateCheckoutFromCurrentCartOptions): Promise<CreateCheckoutResponse & CreateCheckoutResponseNonNullableFields>;
export interface CreateCheckoutFromCurrentCartOptions {
    /** **Required**. Sales channel type. */
    channelType?: ChannelType;
    /** Shipping address. Used for calculating tax and shipping (when applicable). */
    shippingAddress?: Address;
 ...
 */
export declare function removeCouponFromCurrentCart(): Promise<RemoveCouponResponse & RemoveCouponResponseNonNullableFields>;
/**
 ...
 */
export declare function updateCurrentCartLineItemQuantity(lineItems: LineItemQuantityUpdate[]): Promise<UpdateLineItemsQuantityResponse & UpdateLineItemsQuantityResponseNonNullableFields>;
/**
 ...
 */
export declare function estimateCurrentCartTotals(options?: EstimateCurrentCartTotalsOptions): Promise<EstimateTotalsResponse & EstimateTotalsResponseNonNullableFields>;
export interface EstimateCurrentCartTotalsOptions {
    /** Selected shipping option. */
    selectedShippingOption?: SelectedShippingOption;
    /** Shipping address. Used for calculating tax and shipping (when applicable). */
    shippingAddress?: Address;
 ...
 */
export declare function deleteCurrentCart(): Promise<void>;
export {};
